...
Pay attention that given the vals from=x, to=y in the conf file, it will change bytes x to y (without y). So if you want to change until byte 3, give it the val of 4 in the to field (in case of little edian.
